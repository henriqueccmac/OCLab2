...
/*Fui eu que criei*/
#define OFFSET_SIZE ((int)log2(BLOCK_SIZE))

#define L1_LINES ((int)L1_SIZE/BLOCK_SIZE)
#define L1_INDEX_SIZE ((int)log2(L1_LINES))
#define L1_TAG_SIZE ((int)(WORD_SIZE*8)-OFFSET_SIZE-L1_INDEX_SIZE)

#define L2_LINES ((int)L2_SIZE/(BLOCK_SIZE*2))
#define L2_INDEX_SIZE ((int)log2(L2_LINES))
#define L2_TAG_SIZE ((int)(WORD_SIZE*8)-OFFSET_SIZE-L1_INDEX_SIZE)
/*******************/
